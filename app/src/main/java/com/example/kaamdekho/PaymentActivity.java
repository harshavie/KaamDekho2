...
public class PaymentActivity extends AppCompatActivity {
    EditText amount,note,name,upivrtualid;
    Button send;
    String TAG = "main";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upivrtualid = (EditText)findViewById(R.id.upi_id);
        send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(TextUtils.isEmpty(name.getText().toString().trim())){
                    Toast.makeText(PaymentActivity.this, "Your Name is Invalid", Toast.LENGTH_SHORT).show();
                                    }
                else if(TextUtils.isEmpty(upivrtualid.getText().toString().trim())){
                    Toast.makeText(PaymentActivity.this, "Enter valid upi id", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(note.getText().toString().trim())){
                    Toast.makeText(PaymentActivity.this, "Enter valid note", Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(amount.getText().toString().trim())){
                    Toast.makeText(PaymentActivity.this, "Enter valid amount", Toast.LENGTH_SHORT).show();
                }else{
                    payUsingUpi(name.getText().toString(), upivrtualid.getText().toString(),
